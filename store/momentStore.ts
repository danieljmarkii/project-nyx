...
// Arm the hide, recording the deadline so a pause can bank the remainder. The single
// place a hide timer is created, so `hideDeadlineAt` cannot drift from `hideTimer`.
