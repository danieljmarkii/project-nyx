...
// node is open. Everything a node says is the model's (`lib/spineNode.ts`); how a node
// looks is the row's (`SpineNodeRow.tsx`); this file only threads them.
//
...
import type { SpineNode } from '../../../lib/spineNode';
import { SpineCompactRow, SpineEventRow } from './SpineNodeRow';

export function Spine({ nodes, onOpen }: { nodes: SpineNode[]; onOpen?: (id: string) => void }) {
