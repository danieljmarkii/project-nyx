...
describe('FoodsTrialStrip', () => {
  const MODEL = { header: 'Diet trial — day 12 of 28', line: '3 foods on the trial list' };
  ...
  it('renders both lines', () => {
    ...
    expect(getByText('3 foods on the trial list')).toBeTruthy();
  });
  ...
  it('announces both facts and what the tap does', () => {
    ...
    expect(
      getByLabelText('Diet trial — day 12 of 28. 3 foods on the trial list. See the trial list.'),
    ).toBeTruthy();
  });
});
