...
import { GlyphSvg, type Glyph, type GlyphProps } from '../glyphs/GlyphSvg';
...
//
// The house line style (24×24, no fill, 1.75 stroke, round caps + joins) lives in
// the shared GlyphSvg wrapper (components/glyphs/GlyphSvg.tsx) — it moved there
// when the tab bar's family needed the same line (CUL-599); the drawing below is
// unchanged. Per B-410 the home-screen widget does NOT adopt these — it runs its
// own inlined abstract geometry in a bare JSC context with no imports, so a
// react-native-svg component could never reach it anyway.

// The event family's names for the shared glyph contract. Kept as aliases rather
// than replaced at the call sites: EVENT_TYPES and EventIcon speak in "event
// glyph", and the wrapper's move is an implementation detail they shouldn't feel.
