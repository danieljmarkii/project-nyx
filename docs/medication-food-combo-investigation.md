...
**Backlog:** B-156 | **Date:** 2026-06-22 (updated 2026-06-23) | **Status:** Phase A (Slice B `how_given`) shipped (A1–A3, #225–#227); **Phase B (the combo) now building** — PR B1 schema (#229) + PR B2 plumbing landed 2026-06-23, and all three Phase-B gates are resolved (G1 PM #221; **G2 this session — two independent cross-linked edit instances**; G3 via #228), leaving only the build-time **G4** inside PR B3. This doc is an investigation + (now largely un-gated) build plan; §10 carries the live PR status.
