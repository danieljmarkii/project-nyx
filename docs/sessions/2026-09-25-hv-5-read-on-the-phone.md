...
Shipped via #912 (fixes CUL-1162). Filed: CUL-1188, CUL-1197, CUL-1198, CUL-1200, CUL-1201, CUL-1202, CUL-1203, CUL-1204. Handoffs posted on CUL-1158 (HV-1), CUL-1163 (HV-6) and CUL-552.
...
- Jest green after merging `main`: 470 suites, 10,135 passed; `tsc` clean; the touched suites green under Kiritimati, Chatham and Honolulu.
- Read-only against the live database: the policy, grants and triggers on `event_ai_analysis` (for CUL-1203).
...
- **Second pass on the review round:** see the PR.
...
- **CUL-1188** (updated, now Medium): the shared hydration pager has both the short-page and the suspension shapes; the copy's keyset tests transfer.
