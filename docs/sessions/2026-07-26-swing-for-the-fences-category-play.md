...
- `docs/backlog.md` — added **B-467** (published-validation program, Later) and **B-468** (ASO keyword-volume validation, Next). Protocol-sanctioned additions; no scope invented beyond them.
