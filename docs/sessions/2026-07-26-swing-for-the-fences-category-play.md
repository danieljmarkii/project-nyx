...
- `docs/backlog.md` — added **B-457** (published-validation program, Later) and **B-458** (ASO keyword-volume validation, Next). Protocol-sanctioned additions; no scope invented beyond them.
