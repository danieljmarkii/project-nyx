...
- **B-579** (new) — port `scopeVetDocumentPaths`' whole-shape guard to `scopeFoodPaths`. Edge Function change, deliberately out of the schema PR — the same split 042 and 043 both made.
