...
- `lib/dayNodes.ts` dropping the prior onsets, the free-fed spans, the config or the analysis, or crossing the photo and working sets → each reds the sweep. The sweep's own floor proves it can see each of the seven facts.
