...
| Med context | `During an active {drug} course — {n} doses logged.` |
| Density withheld (expanded) | `You also logged on fewer days this week, so we can't tell yet whether there was less to log.` |
