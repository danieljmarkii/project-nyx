...
## §V Verification addendum (2026-09-24, CUL-1117)

Additive, per the frozen-brief convention: the claim above keeps its published wording and carries the ⚠ pointer to this row.

### §V.1 The hepatic-lipidosis durations

| The claim as published | The verified position | Sources checked |
|---|---|---|
| §3 — "Hepatic lipidosis can develop after as little as 2–3 days of complete anorexia, and more reliably after 1–2 weeks of *reduced* intake", citing Merck, Cornell and Wallace 2024 | **Neither duration appears on any of the three cited pages.** Merck's feline hepatic lipidosis page (S. Center, updated June 2025) and Cornell's hepatic lipidosis page state no anorexia duration at all; Wallace 2024 is about time to enteral feeding after admission (≤12 h vs >12 h), not onset. The only experimental onset data are Biourge 1993/1994: clinical lipidosis after **5 to 7 weeks** of fasting in cats more than 40% overweight. The best-grounded clinical line is the ISFM 2022 consensus: intake under 80% of resting energy requirement for **under 3 days is low risk**, 3 to 5 days moderate, over 5 days high, with intervention "no later than 3 days after the cessation of eating". | Merck https://www.merckvetmanual.com/digestive-system/hepatic-diseases-of-small-animals/feline-hepatic-lipidosis ; Cornell https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feline-health-topics/hepatic-lipidosis (both fetched 2026-09-24); Biourge 1994 https://doi.org/10.2460/ajvr.1994.55.09.1291 ; ISFM 2022 https://pmc.ncbi.nlm.nih.gov/articles/PMC11107985/ |

**What survives:** the paragraph's operative conclusion. A cat that has *stopped eating* for about 24 hours should be discussed with a vet (Cornell: anorexia "can have a severe impact on a mature cat's health if it persists for as little as 24 hours"; Merck's owner table: "failure to eat or drink for 24 hours"), because anorexia is a non-specific sign of most feline disease. **What does not:** attaching a hepatic-lipidosis mechanism to the 24 to 48 hour line, and treating *reduced* intake over a day as the same signal. Full evidence: `docs/research/2026-09-engines-evidence-pack.md`, Lane E §5.
