...
| **Home Redesign — Conference Spike** | New (2026-08-31). CEO conference mandate (~end Nov 2026, date TBD). Research briefs shipped; **D1–D4 rulings on `Waiting on PM` (CUL-775) gate everything else**; then mock rounds → build-ready spec → build dark behind a flag → beta → GA. |
