...
| **Home v1 — The Signal fold** | New (2026-09-03). The minimize/expand on Signal cards, all accounts, no flag — a read card folds to one calm line and the record, never a timer, brings it back. Spec `docs/nyx-signal-fold-requirements.md` v1.2, every ruling in; **the project description carries the PR-by-PR run order** (PR 1 CUL-784 ready; PR 2 CUL-785; PR 3 CUL-788; v1.1 CUL-786 / CUL-787). Home v2 is the separate *Home Redesign — Conference Spike*. |
