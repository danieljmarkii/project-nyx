...
export interface DerivedProtein {
   ...
   * moment if the provenance ever reaches a surface (B-461).
   */
  unusual: boolean;
}
...
//
// ── TWO EXCLUSIONS THAT ARE THE PM'S CALL, NOT THIS MODULE'S (B-462) ──────────
//
...
// reaches the contaminant check. That needs a design pass, so it is B-462.
